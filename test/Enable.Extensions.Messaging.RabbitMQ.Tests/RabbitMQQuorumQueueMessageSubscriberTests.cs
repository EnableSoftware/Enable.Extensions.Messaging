...
{
    public class RabbitMQQuorumQueueMessageSubscriberTests : IClassFixture<RabbitMQTestFixture>, IDisposable
    {
        ...
        public RabbitMQQuorumQueueMessageSubscriberTests(RabbitMQTestFixture fixture)
        {
            ...
            var messagingClientFactory = new RabbitMQQuorumQueueMessagingClientFactory(options);
