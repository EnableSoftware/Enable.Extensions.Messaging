...
{
    public class RabbitMQQuorumQueueMessagePublisherTests : IClassFixture<RabbitMQTestFixture>, IDisposable
    {
        ...
        public RabbitMQQuorumQueueMessagePublisherTests(RabbitMQTestFixture fixture)
        {
